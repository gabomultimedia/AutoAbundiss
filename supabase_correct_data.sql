-- Archivo SQL CORRECTO para insertar datos de ejemplo en Abundiss Console
-- Basado en la estructura real de las tablas
-- Ejecutar en Supabase SQL Editor

-- 1. Insertar promociones de ejemplo (estructura correcta)
...
-- 2. Insertar entradas de KB de ejemplo (con priority - SÍ existe)
...
-- 3. Insertar conversaciones de ejemplo (con metadata - SÍ existe)
...
-- 4. Insertar archivos de ejemplo (con metadata - SÍ existe)
...
-- 5. Insertar eventos de calendario de ejemplo (con metadata - SÍ existe)
...
-- 6. Insertar mensajes en buffer de ejemplo (SIN metadata - NO existe)
INSERT INTO public.msg_buffer (chat_id, usuario_id, mensaje, attachment_type, attachment_link) VALUES
('chat_001', 'user_001', 'Hola, ¿cómo están?', NULL, NULL),
('chat_002', 'user_002', 'Necesito información sobre servicios', NULL, NULL),
('chat_003', 'user_003', '¿Tienen promociones activas?', NULL, NULL);
