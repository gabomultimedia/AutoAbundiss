-- Datos de ejemplo para evitar errores 400 en el dashboard

-- Insertar promociones de ejemplo
INSERT INTO public.promotions (title, description, discount_percent, starts_at, ends_at, is_active, priority) VALUES
('Descuento de Bienvenida', '20% de descuento en tu primera compra', 20, NOW() - INTERVAL '30 days', NOW() + INTERVAL '30 days', true, 1),
('Oferta Especial', '15% de descuento en productos seleccionados', 15, NOW() - INTERVAL '15 days', NOW() + INTERVAL '15 days', true, 2),
('Promoción de Verano', '25% de descuento en productos de temporada', 25, NOW() - INTERVAL '7 days', NOW() + INTERVAL '60 days', true, 3)
ON CONFLICT (id) DO NOTHING;

-- Insertar entradas de KB de ejemplo
...
-- Insertar mensajes en buffer de ejemplo
...
-- Insertar configuración de la aplicación
